...
namespace GG.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Testimonialid,Userid,Recipeid,Content,Testimonialdate")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Testimonialid,Userid,Recipeid,Content,Testimonialdate")] Testimonial testimonial)
        {
